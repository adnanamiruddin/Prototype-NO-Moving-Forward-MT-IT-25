...
// ============================================================================
// INITIAL DOCUMENT LIST DATA (Extracted from "List Evidence" image)
// ============================================================================
...
export const EvidenceRow = ({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-2 items-center py-1.5 px-3 border-b border-slate-200 hover:bg-slate-50 transition-colors text-xs">
      ...
      {/* Action Buttons (Folder & Search/Preview) */}
...
export const EvidenceFormList = () => {
  ...
  // Handle File Selection simulation
  const handleFileChange = (id) => {
    setUploadingId(id);
    setShowProcessing(true);
    document.body.style.cursor = "wait";
    setTimeout(() => {
      window.location.href = "/request-timeout";
    }, 5000);
  };
...
// ============================================================================
export default function LoadingRequestTimeoutPage() {
