...
/* ================================================================
   DUMMY DATA: INQUIRY PUPJ RESULTS
   ================================================================ */
const DUMMY_INQUIRY_RESULTS = [
  {
    pupjNo: "PUPJ-2026-001",
    itemNo: "ITEM-78291",
    buyerName: "Budi Santoso",
    units: [
      {
        cab: "JKT",
        cabangContract: "JKT-001",
        contractNo: "CNT-112233",
        brand: "Honda",
        objectCode: "HND-VARIO160",
        model: "Vario 160 CBS",
        tahun: "2025",
        hargaPengajuan: "27.500.000",
      },
      {
        cab: "JKT",
        cabangContract: "JKT-001",
        contractNo: "CNT-112234",
        brand: "Honda",
        objectCode: "HND-VARIO160",
        model: "Vario 160 CBS",
        tahun: "2025",
      ...
      {
        cab: "BDG",
        cabangContract: "BDG-005",
        contractNo: "CNT-221144",
        brand: "Honda",
        objectCode: "HND-PCX160",
        model: "PCX 160 ABS",
        tahun: "2024",
        hargaPengajuan: "34.000.000",
      },
    ],
  },
  {
    pupjNo: "PUPJ-2026-002",
    itemNo: "ITEM-88342",
    buyerName: "Andi Wijaya",
    units: [
      {
        cab: "SBY",
        cabangContract: "SBY-012",
        contractNo: "CNT-334455",
        brand: "Honda",
        objectCode: "HND-CBR150R",
        model: "CBR 150R ABS",
        tahun: "2025",
        hargaPengajuan: "39.500.000",
      },
    ],
  },
  {
    pupjNo: "PUPJ-2026-003",
    itemNo: "ITEM-78291",
    buyerName: "Rina Susanti",
    units: [
      {
        cab: "JKT",
        cabangContract: "JKT-003",
        contractNo: "CNT-556677",
        brand: "Honda",
        objectCode: "HND-BEAT",
        model: "Beat Deluxe",
        tahun: "2025",
        hargaPengajuan: "19.000.000",
      },
      {
        cab: "JKT",
        cabangContract: "JKT-003",
        contractNo: "CNT-556678",
        brand: "Honda",
        objectCode: "HND-BEAT",
        model: "Beat Deluxe",
        tahun: "2025",
...
/* ================================================================
   2. TOOLBAR  (+ Inquiry PUPJ button)
   ================================================================ */
const ToolBar = ({ onInquiry }) => (
  <div className="bg-[#f0f4f8] border-b border-gray-300 px-2 py-1 flex items-center gap-1 text-gray-700 shadow-sm">
    ...
    <div className="h-4 w-[1px] bg-gray-300 mx-1" />
    {/* ===== IMPROVEMENT: Inquiry PUPJ Button ===== */}
    <button
      onClick={onInquiry}
      title="Inquiry PUPJ"
      className="p-1 hover:bg-blue-100 rounded border border-transparent hover:border-blue-400 flex items-center gap-1 px-2"
    >
      <FaSearch className="w-3.5 h-3.5 text-blue-700" />
...
/* ================================================================
   10. INQUIRY PUPJ MODAL  (IMPROVEMENT)
   ================================================================ */
const InquiryModal = ({ isOpen, onClose }) => {
  const [searchMode, setSearchMode] = useState("itemNo"); // "itemNo" | "buyerName"
  const [searchValue, setSearchValue] = useState("");
  const [results, setResults] = useState([]);
  const [expandedPupj, setExpandedPupj] = useState(null);
  ...
  const handleSearch = () => {
    ...
    const filtered = DUMMY_INQUIRY_RESULTS.filter((r) => {
      if (searchMode === "itemNo") {
        return r.itemNo.toLowerCase().includes(searchValue.toLowerCase());
      }
      return r.buyerName.toLowerCase().includes(searchValue.toLowerCase());
    });
    setResults(filtered);
    setExpandedPupj(null);
  };
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-5xl border border-gray-400 overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="bg-[#3b5998] text-white px-4 py-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <FaSearch className="w-4 h-4" />
            <h3 className="font-bold text-sm">
              Inquiry PUPJ — Pencarian Unit Persiapan Jual
            </h3>
          </div>
        ...
        {/* Search Section */}
        <div className="p-4 border-b border-gray-300 bg-[#f8fafc] space-y-3">
          <div className="flex items-center gap-4 text-xs">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer">
              <input
                ...
                name="searchMode"
                value="itemNo"
                checked={searchMode === "itemNo"}
                onChange={() => {
                  setSearchMode("itemNo");
                  setSearchValue("");
                  setResults([]);
                }}
                className="accent-blue-700"
              />
              <span>Nomor Item</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer">
              <input
                type="radio"
                name="searchMode"
                value="buyerName"
                checked={searchMode === "buyerName"}
                onChange={() => {
                  setSearchMode("buyerName");
                  setSearchValue("");
                  setResults([]);
                }}
                className="accent-blue-700"
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 max-w-md bg-amber-50 border border-gray-400 px-3 py-1.5 rounded-sm text-xs focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-500"
            />
            <button
              onClick={handleSearch}
              className="bg-gradient-to-b from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 text-white px-4 py-1.5 rounded text-xs font-semibold border border-blue-900 shadow-sm flex items-center gap-1.5 active:scale-95 transition-all"
            >
            ...
            <button
              ...
              className="bg-gray-200 hover:bg-gray-300 text-gray-700 px-3 py-1.5 rounded text-xs font-medium border border-gray-400 transition-all"
            >
              Reset
            </button>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-white">
          {results.length === 0 ? (
            <div className="text-center text-gray-400 text-xs py-8">
              {searchValue.trim()
                ? "Tidak ada data PUPJ yang cocok dengan pencarian."
                : "Silakan masukkan kata kunci dan klik Search."}
            </div>
          ) : (
              ...
              {results.map((pupj) => (
                ...
                >
                  ...
                  <div
                    onClick={() =>
                      setExpandedPupj(
                        expandedPupj === pupj.pupjNo ? null : pupj.pupjNo,
                      )
                    }
                    className="bg-[#e2e8f0] px-3 py-2 flex items-center justify-between cursor-pointer hover:bg-[#d1d8e0] transition-colors"
                  >
                    <div className="flex items-center gap-4 text-xs font-semibold text-gray-800">
                      <span className="text-blue-900">{pupj.pupjNo}</span>
                      <span className="text-gray-500">|</span>
                      <span>Item: {pupj.itemNo}</span>
                      <span className="text-gray-500">|</span>
                      <span>Buyer: {pupj.buyerName}</span>
                      <span className="text-gray-500">|</span>
                      <span className="bg-blue-100 text-blue-800 px-2 py-0.5 rounded-full text-[10px]">
                        {pupj.units.length} Unit
                      </span>
                    </div>
                    <div className="flex items-center gap-1 text-xs text-blue-700">
                      <FaEye className="w-3 h-3" />
                      <span>
                        {expandedPupj === pupj.pupjNo
                          ? "Sembunyikan"
                          : "Lihat Detail Unit"}
                      </span>
                    </div>
                  ...
                  {expandedPupj === pupj.pupjNo && (
                    <div className="border-t border-gray-300">
                      <table className="w-full border-collapse text-[11px]">
                        <thead>
                          <tr className="bg-[#f1f5f9] text-gray-600 font-semibold border-b border-gray-200">
                            <th className="p-1.5 text-left w-12">Cab</th>
                            <th className="p-1.5 text-left w-32">
                              Cabang Contract
                            </th>
                            <th className="p-1.5 text-left w-28">
                              Contract No
                            </th>
                            <th className="p-1.5 text-left w-24">Brand</th>
                            <th className="p-1.5 text-left w-24">
                              Object Code
                            </th>
                            <th className="p-1.5 text-left w-28">Model</th>
                            <th className="p-1.5 text-left w-16">Tahun</th>
                            <th className="p-1.5 text-right w-28">
                              Harga Pengajuan
                            </th>
                          </tr>
                        </thead>
                        <tbody>
                          {pupj.units.map((unit, uIdx) => (
                            <tr
                              key={uIdx}
                              className="border-b border-gray-100 hover:bg-blue-50/50"
                            >
                              <td className="p-1.5">{unit.cab}</td>
                              <td className="p-1.5">{unit.cabangContract}</td>
                              <td className="p-1.5 font-mono">
                                {unit.contractNo}
                              </td>
                              <td className="p-1.5">{unit.brand}</td>
                              <td className="p-1.5">{unit.objectCode}</td>
                              <td className="p-1.5">{unit.model}</td>
                              <td className="p-1.5">{unit.tahun}</td>
        ...
        {/* Footer */}
        <div className="bg-[#e5e9f0] border-t border-gray-400 px-4 py-2 flex justify-between items-center text-xs">
          <span className="text-gray-600">
            Total PUPJ Found: <strong>{results.length}</strong>
          </span>
          <button
            onClick={onClose}
            className="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-1 rounded border border-gray-400 font-medium transition-all"
          >
            Close
          </button>
        </div>
...
/* ================================================================
   MAIN
   ================================================================ */
export default function PupjAfterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f4f6f8] font-sans flex flex-col justify-between text-gray-800">
      <div className="flex-1 flex flex-col">
        <MenuBar />
        <ToolBar onInquiry={() => setShowInquiry(true)} />
        <FormHeaderInfo />
      ...
      {/* ===== IMPROVEMENT: Inquiry PUPJ Modal ===== */}
      <InquiryModal
        isOpen={showInquiry}
